        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            @guest
              ...
              <x-nav-link href="/register" :active="request()->is('register')" class="ml-3">Register</x-nav-link>
            @endguest
            @auth
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Poka Hermann</div>
            <div class="text-sm font-medium leading-none text-gray-400">pokatchoneng@gmail.com</div>
          </div>
